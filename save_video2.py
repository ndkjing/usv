...
rtmp_video_urls = [
    ...
    'rtmp://rtmp01open.ys7.com:1935/v3/openlive/L09226970_1_2?expire=1705141991&id=535889408881078273&t=563d93a518b5be2f49e9b7ffc3653ec72213da0f1abd3dbe1dbca6ea8de9ee9c&ev=100'
...
def save_video(index):
    ...
    save_path = os.path.join(os.path.join(save_video_path, str(index+2)),'%d_%s.avi'%(index+2,str_time))
